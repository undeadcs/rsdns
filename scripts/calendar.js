DateInput = (function($){
	...
	selectMonth: function(date, dontCache){
		var newDate = new Date(date.getFullYear(), date.getMonth(), 1);
		// alert(this.currentMonth+'\r\n'+newDate);
		if (!dontCache && this.currentMonth + '' == newDate + ''){
	...
	selectDate: function(date){
		if (typeof (date) == "undefined") date = this.stringToDate(this.input.val());
		if (date){
	...
	moveMonthBy: function(amount){
		this.selectMonth(new Date(this.currentMonth.setMonth(this.currentMonth.getMonth() + amount)), true);
	},
