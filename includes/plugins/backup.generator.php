<?php
	 ...
	 * 	/usr/local/bin/php /var/www/named/www/includes/plugins/backup.generator.php
	 */
	...
	$objCMS->ApplyPath( "system_styles", $objCMS->GetPath( "root_system" )."/styles" );
		//*/
		$modBackup = new CHModBackup( );
		$modBackup->MakeBackup( BCT_SOURCE | BCT_DBDUMP | BCT_FILEZONE, "Ymd" );
		$modBackup->DeleteOldBackups( );
	}
?>